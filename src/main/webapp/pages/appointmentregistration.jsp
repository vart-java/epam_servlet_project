...
<h1 class="text-center"> Registration on procedure <c:out value="${requestScope.master.specialization.name}"/> to the <span
        class="badge bg-primary"><c:out value="${requestScope.master.simpleName}"/></span></h1>
<h4 class="text-center">Please choose the time you need for the procedure on <c:out value="${requestScope.Time}"/></h4>
