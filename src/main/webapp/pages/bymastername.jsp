...
<h1 class="text-center"> <fmt:message key="choose_your_m"/> <span
    ...
    <div class="row">
        <div class="col-lg-3">
            <form action="/main" method="post">
                ...
                <button type="submit" class="btn btn-primary" name="command" value="regToApp" ><fmt:message key="submit"/></button>
            </form>
        </div>
    </div>
</div>
